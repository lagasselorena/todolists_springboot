...
## Nota
O banco H2 roda em memória — os dados são reiniciados toda vez que o servidor é reiniciado. Para inspecionar o banco visualmente, acesse http://localhost:8080/h2-console (JDBC URL: jdbc:h2:mem:tododb).
